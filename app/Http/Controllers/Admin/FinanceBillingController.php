...
class FinanceBillingController extends Controller
{
    ...
    {
        $billings = Budget::with(['project:id,name', 'category:id,name'])->paginate(15);
        $projects  = Project::orderBy('name')->get();
        $categories  = Category::orderBy('name')->get();
        return view('finance-billing', compact('billings', 'projects', 'categories'));
    }
    ...
    public function addBudget(Request $request)
    {
        ...
        return redirect()->route('finance-billing')->with('success', 'budget added successfully.');
    }
    ...
    public function update(Request $request, Budget $budget)
    {
        ...
        return redirect()->route('finance-billing')->with('success', 'budget updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        $budget->delete();
        return redirect()->route('finance-billing')->with('success', 'budget deleted.');
    }
    //filter budget
